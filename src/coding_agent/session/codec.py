...
def pending_from(value: dict[str, object]) -> PendingPermission:
    ...
    return PendingPermission(
        ...
        preview=(None if preview_value is None else object_value(preview_value, "preview")),
        confirmation_fingerprint=str(value["confirmation_fingerprint"]),
        tools_used=tuple(str(item) for item in array_value(value["tools_used"], "tools_used")),
